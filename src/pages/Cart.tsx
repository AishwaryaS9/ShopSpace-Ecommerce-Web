                        ...
                        <div>
                            ...
                            <div className="total mt-6 flex justify-between items-center border-t pt-4">
                                ...
                                <span className="text-lg font-semibold text-gray-800">
                                    {/* ${cartItems.reduce((total: any, item: any) => total + item.price, 0).toFixed(2)} */}
                            ...
                            {/* <div className="checkout mt-6">
                                <button className="bg-green-500 text-white px-6 py-3 rounded-lg w-full font-medium hover:bg-green-600 transition">
                                    Proceed to Checkout
                                </button>
                            </div> */}
                        </div>
